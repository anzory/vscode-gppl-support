...
export const gpplComletionsItems: CompletionItem[] = [
  ...
  },
  {
    ...
    documentation: '`dup(string, count)` returns a string value, consisting of the string `string` duplicated `count` times',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'instr()',
    ...
    documentation: '`instr(str, substr, val)` searches for the appearance of the `substr` in `str` from the `val` column and returns its position from the beginning of `str`',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'left()',
  ...
  },
  {
    ...
    documentation: '`lower(string)` returns the same `string`, where all upper case (capital) letters (a-z) are replaced by their lower case equivalent (a-z)',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'replace()',
    ...
    documentation: '`replace(str, oldstr, newstr , k)` replace the `k` appearance of the `oldstr` in `str` with `newstr` and returns the `str`',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'rev()',
  ...
  },
  {
    ...
    documentation: '`substr(string, from, len)` returns the sub-string starting in the `string` from position `from`, and with length `len`',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'time()',
  ...
  },
  {
    ...
    documentation: '`tonum(string)` converts the number represented in the `string` from string format to a numeric format',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'tostr()',
    ...
    documentation: '`tostr(number:format)` converts the `number` into string notation according to the format specification `format`',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'trim()',
  ...
  },
  {
    ...
    documentation: '`upper(string)` returns the same `string`, where all the lower case letters (a-z) are replaced by their upper case (capital) equivalent (A-Z)',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'abs()',
    ...
    documentation: '`abs(number)` returns the arc cosine of the `number`. The angle returned is in degrees in the range (0, 180)',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'acos()',
    ...
    documentation: '`acos(number)` returns the arc cosine of the `number`. The angle returned is in degrees in the range (0, 180)',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'adims()',
  ...
  },
  {
    ...
    documentation: '`ang(x, y)` returns the angle between vector to the point and the positive direction of the `X axis`',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'asin()',
    ...
    documentation: '`asin(number)` returns the arc sine of the `number`. The angle returned is in degrees in the range (-90, 90)',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'asize()',
  ...
  },
  {
    ...
    documentation: '`atan(number)` returns the arc tangent of the `number`. The angle returned is in degrees in the range (-90, 90)',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'atan2()',
  ...
  },
  {
    ...
    documentation: '`round(number, dig)` returns the number rounded to the required number of digits either after or before the decimal point',
    kind: CompletionItemKind.Function,
  },
  {
    label: 'round2val()',
